    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4 padding-right">
                <?php if ($result): ?>
                    <p class="success">Задача добавлена!</p>
                    <p class="success">Вы будете перенаправлены на страницу задач через 5 сек.</p>
                    <meta http-equiv="refresh" content="4, url='/index/order-id/sort-desc/page-1'">
                    <p class="success">Если этого не произошло, кликните сюда:</p>
                    <?php if ($result): ?>
                        <a href="/index/order-id/sort-desc/page-1" class="btn btn-default"><i class="fa fa-user"></i> Домой</a>
                    <?php endif; ?>
                <?php else: ?>
